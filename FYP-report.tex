...
The chapter below is adapted from \cite{D_Anjou_2019} and \cite{reinhold2019} as they explain the physical system and Hamiltonians very well. This project focuses much more on optimization than on the physical systems themselves.
\par
...
\par
Having discussed the original full Hamiltonian (as referenced later in chapter \ref{sec:further_discussions}), as discussed earlier this project focuses more on optimization using the effective Hamiltonian in the dispersive regime where the DQD is effectively a two-level system. 
...
The constants in this effective Hamiltonian include resonator frequency $\omega_c$, qubit anharmonicity $\omega_q$ and cavity-qubit coupling strength $\chi$. 
...
However, exact numbers of these constants may depend on specific physical systems that the optimization scheme discussed in this report is applied to. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
