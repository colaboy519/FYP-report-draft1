...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Pulse constraints} \label{sec:pulse_constraints}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Troubleshooting Optimization Algorithm}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{vacuum to cat state, cavity coupled with single qubit(effective)}\label{sec:vac2cat}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Further discussions}\label{sec:further_discussions}
...
See How-to chapter, "How to define a new optimization functional" in Krotov documentation for details. \cite{GoerzSPP2019}
...
\lstinputlisting[
    ...
    label=code:elective_spin_flip]{elective_spin_flip.py}
